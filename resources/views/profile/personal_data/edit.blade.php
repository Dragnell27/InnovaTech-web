    ...
    <form action="{{ route('users.update', Auth::user()->id) }}" method="post">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="nombre" value="{{ $data['data'][0]['first_name'] }}"
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="apellido" value="{{ $data['data'][0]['last_name'] }}"
        ...
        <div class="row mb-3">
                ...
                <select class="form-select" id="tipo_documento" name="tipo_de_documento" required>
                    ...
                    @foreach ($document_types as $type)
                        <option value="{{ $type->id }}"
                            {{ old('tipo_de_documento', $data['data'][0]['document_type']['id']) == $type->id ? 'selected' : '' }}>
                            {{ $type->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="col-md-6">
                ...
                <input type="text" value="{{ $data['data'][0]['document'] }}" class="form-control" id="numero_documento"
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="tel" value="{{ old('phone', $data['data'][0]['phone']) }}" name="phone"
            ...
            <div class="col-md-6">
                ...
                <input type="email" value="{{ old('email', $data['data'][0]['email']) }}" class="form-control"
            ...
            <div class="col-md-12">
                <div class="mb-3 form-check">
                    <input type="checkbox" id="accept_subscription" name="accept_subscription" class="form-check-input"
                        @if ($data['data'][0]['suscription'] == 20) checked @endif>
