        ...
        <div class="row mt-4">
            ...
            <main class="col-12">
                ...
                <section id="section-mision" class="section-about" >
                    ...
                    <img src="{{ asset('img/mision.jpg') }}" alt="Imagen de la Misión" class="imagenes">
                ...
                <section id="section-historia" class="section-about">
                    ...
                    <img src="{{ asset('img/mision_empresa.jpg') }}" alt="Imagen de la Historia" class="imagenes">
                ...
                <section id="section-equipo" class="section-about">
                    ...
                    <img src="{{ asset('img/mision_empresa.jpg') }}" alt="Imagen de Nuestro Equipo" class="imagenes">
                ...
                <section id="section-vision" class="section-about">
                    ...
                    <img src="{{ asset('img/mision_empresa.jpg') }}" alt="Imagen de Nuestra Visión" class="imagenes">
