                            ...
                            <div class="product-content">
                                ...
                                <div class="product-right">
                                    <div class="price-row">
                                        ...
                                        @endif
                                        <button class="btn btn-danger btn-cart" data-id="{{ $productos->id }}">Añadir al Carrito</button>
                                    </div>
                                    <button class="{{ $agregado_lista }} btn float-end mt-3" data-product_id="{{ $productos->id }}"
