...
//Pago con wompi
var precioPagar = (jsVariable)*100;
var scriptElement = document.querySelector('script[src="https://checkout.wompi.co/widget.js"]');
if(scriptElement){
    scriptElement.setAttribute('data-amount-in-cents',precioPagar.toString());
}
